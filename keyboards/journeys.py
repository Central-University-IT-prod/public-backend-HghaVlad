...
journey_notes_delete_keyboard = InlineKeyboardMarkup()
journey_delete_note_yes = InlineKeyboardButton("Да", callback_data="journey_delete_note_yes")
journey_delete_note_no = InlineKeyboardButton("Нет", callback_data="journey_delete_note_no")
journey_notes_delete_keyboard.add(journey_delete_note_yes, journey_delete_note_no)
